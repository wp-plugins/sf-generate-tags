...
function sf_generate_tags() {
	...
	//split sting and make an array of words
	...
	$commaSeparatedTags = implode(",", $tagsArrayExcludedLiterals);
...
function removeWordsWithLiterals($input_array)
{
	...
	$letters_only="/^\pL+$/u";
	$easy_words = array('about', 'above', 'again', 'ago', 'also', 'always', 'and', 'any', 'anyone', 'are', 'all', 
		'but', 'due', 'either', 'extra', 'false', 'for', 'from', 'here', 'how',
		'inn', 'into', 'its', 'jpg', 'just', 'less', 'more', 'not', 
		'only', 'our', 'ours', 'out', 'png', 'since', 'she', 'sure', 'such',
		'than', 'that', 'the', 'then', 'there', 'these', 'they', 'those', 'this', 'thus', 'true', 
		'what', 'where', 'while', 'who', 'whose', 'why', 'with', 
		'yes', 'yet', 'you', 'your', 'yours');
	$verbs = array('able', 'add', 'afford', 'being', 'can', 'come',
		'did', 'does', 'doing', 'done', 
		'find', 'found', 'get', 'going', 
		'has', 'have', 'let', 'put',
		'say', 'see', 'set', 'tell', 'try', 'use', 'want', 'was', 'were', 'will');
